                ...
                >
                  <div className="flex flex-row">
                    ...
                    <div className="flex flex-col justify-center sm:ml-4">
                      ...
                      {/* this is for dropdown to see insights */}
                      
                      <div className="flex">
                        {avgStars[`${student_email}-${language_name}`]== 0 ? '-' : <StaticStar count={avgStars[`${student_email}-${language_name}`] || 0}/> }
                        <span className="ml-2 text-gray-600 mt-2">({<All_review mentorEmail={student_email} mentorLanguage={language_name}/>})</span>
                        <span className="ml-2 text-xl text-gray-600 hover:cursor-pointer">⌄</span>
