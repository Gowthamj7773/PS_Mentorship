...
return (
<div className={`bg-[#EEF1F9] w-full min-h-screen ${filtered_data.length===0 && 'align-center grid'}`}>
    ...
    <div className='w-full pt-21'>
        <div className='w-fit flex flex-row py-2 px-5'>
            ...
            {filtered_data.length===0 && <p className='text-center font-medium text-xl text-gray-500'>No reviews available.</p>}
